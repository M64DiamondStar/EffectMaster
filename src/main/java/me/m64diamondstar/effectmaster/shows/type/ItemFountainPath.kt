...
// Create item
    ...
    override fun getDefaults(): List<Parameter> {
        ...
        list.add(Parameter("Smooth", true, "If true, the items will be spawned with a bezier curve. If false, the items will be spawned with a polygonal chain.", {it.toBoolean()}) { it.toBoolean() })
