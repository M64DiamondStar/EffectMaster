...
class EditShowGui(private val player: Player, effectShow: EffectShow): Gui(player = player) {
    ...
    override fun handleClose(event: InventoryCloseEvent) {
        val clickableComponent = TextComponent(TextComponent("Click here to re-open the edit show gui."))
        clickableComponent.color = ChatColor.of(Colors.Color.BACKGROUND.toString())
        clickableComponent.clickEvent = ClickEvent(ClickEvent.Action.RUN_COMMAND, "/em editor $showCategory $showName")
